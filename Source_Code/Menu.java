...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        // Dummy
        listMhs.add(new Mahasiswa("2107264", "Muhammad Fikri", "A", "Laki-laki"));
    ...
    public final DefaultTableModel setTable() {
        // Column Title
        Object[] column = { "NIM", "Nama", "Nilai", "Kelamin" };
    ...
    public void insertData() {
        ...
        // Add New Data
        listMhs.add(new Mahasiswa(nim, nama, nilai, kelamin));
    ...
    public void updateData() {
        ...
        listMhs.get(selectedID).setKelamin(kelamin);
        ...
        jPanel1Layout.setVerticalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(fieldNilai, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(lblNilai)
                                        .addComponent(btnDelete))
    ...
    private void tblMhsMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_tblMhsMouseClicked
        ...
        String selectedKelamin = (tblMhs.getModel().getValueAt(row, 3).toString());
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        int confirmed = JOptionPane.showConfirmDialog(null, "Apakah yakin ingin menghapus data?", "Confirmation",
